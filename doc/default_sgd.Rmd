...
Here we tune parameters as the dimension of factor and the penalty parameter $\lambda$ by cross-validation.
...
#                    data = data, train = sub_data_train, test = sub_data_test)
# 
